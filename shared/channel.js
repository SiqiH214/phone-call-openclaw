...
export function buildRealtimeInstructions(personaBlock = "") {
  ...
  return [
    ...
    "When the user asks you to look, see them, check the camera, describe what you see, react to their face/room/object, or use visual context, call inspect_view immediately.",
    personaBlock,
  ].filter(Boolean).join("\n\n");
}
